...
export interface IDetailsContactReducer {
  objInfo: ContactDetailsModel | null;
  isInfoError: boolean;
...
export default (state = initialState, action: IDetailsContactProps) => {
  switch (action.type) {
    ...
    case actionTypes.DETAILS_CONTACT_APPOINTMENT_SUCCESS:
      ...
      return { ...state };
    case actionTypes.DETAILS_CONTACT_APPOINTMENT_FAILED:
      state.objAppointment.load.isRefreshing = false;
      state.objAppointment.load.isError = true;
      return { ...state };
    // file Contact
    case actionTypes.DETAILS_CONTACT_FILE_SUCCESS:
      ...
      return { ...state };
    case actionTypes.DETAILS_CONTACT_FILE_FAILED:
      state.objFile.load.isRefreshing = false;
      state.objFile.load.isLoadMore = false;
      state.objFile.load.isError = true;
      return { ...state };
    // interactive Contact
    case actionTypes.DETAILS_CONTACT_INTERACTIVE_SUCCESS:
