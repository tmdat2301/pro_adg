...
import { detailsDealFileRequest, setRefreshingDealFile } from '@redux/actions/detailsActions';
...
const FileTab = (props: FileTab) => {
  ...
  const { objFile, dealId } = useSelector((state: RootState) => state.detailsDealReducer);
        ...
        ListEmptyComponent={() => {
          return (
            <AppEmptyViewList
              ...
              onReloadData={() => dispatch(setRefreshingDealFile(true))}
            />
          );
        }}
        ListFooterComponent={() => {
