...
import { detailsContactFileRequest, setRefreshingContactFile } from '@redux/actions/detailsActions';
...
const FileTab = (props: FileTab) => {
  ...
  const { objFile, contactId } = useSelector((state: RootState) => state.detailsContactReducer);
        ...
        ListEmptyComponent={() => {
          return (
            <AppEmptyViewList
              ...
              onReloadData={() => dispatch(setRefreshingContactFile(true))}
            />
          );
        }}
        ListFooterComponent={() => {
